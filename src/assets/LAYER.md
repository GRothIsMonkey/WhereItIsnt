...
| **The output colour transform / environment lighting** | Found missing by D1 Phase 4's representative scene, and FIXED in the renderer, not here: `src/rendering/color-pipeline.js` encodes once in PostFX and `src/rendering/sky-environment.js` gives PBR materials a sky. This layer's sRGB marking was correct all along and did not change. ARCHITECTURE.md section 4.15. |
